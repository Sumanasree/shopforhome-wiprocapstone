...
import com.gl.shopapi.entity.Discount;
import com.gl.shopapi.vo.helper.ResponseMessage;
...
public class DiscountController {
	...
	public ResponseEntity<ResponseMessage> createCoupon(@PathVariable("code") String code,
	...
	public List<Discount> orderList() {
		...
		ResponseEntity<List<Discount>> responseEntity = restTemplate.exchange(url, HttpMethod.GET, entity,
	...
	public ResponseEntity<Discount> deleteCoupon(@PathVariable("code") Long code) {
		...
		restTemplate.exchange(url, HttpMethod.POST, entity, new ParameterizedTypeReference<ResponseEntity<Discount>>() {
		}).getBody();
